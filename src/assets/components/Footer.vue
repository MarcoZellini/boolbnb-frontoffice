...
<template>
    <footer>
        ...
        <div class="d-flex justify-content-center align-items-center text-secondary py-3">
            ...
            <div class="px-3">-</div>
            <h6 class="text-center m-0">&copy; 2023 <span class="bnb-color">BoolBnB</span> - Made with love by
