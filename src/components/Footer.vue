    ...
    <footer>
        <div class="container">
            <div class="row justify-content-between h-100 py-4">
                ...
                <!-- COLUMN -->
                <div class="col-6 col-md-3 h-100" v-for="n in 4">
        ...
        <div class="d-flex justify-content-center align-items-center text-secondary flex-column flex-sm-row py-3">
            <div class="social d-flex align-items-center justify-content-center gap-2">
                <svg role="button" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div class="px-3 d-none d-sm-inline">-</div>
            <h6 class="text-center mt-2 m-sm-0">&copy; 2023 <span class="bnb-color">BoolBnB</span> - Made with love by
